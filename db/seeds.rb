...
product = Product.create(
    title: 'Rail Scales', 
    description: %(<p><em>Practical Techniques for Performance and Growth</em>
    ...
    software architecture, database access, caching, and more. Even if
    your app may never have millions of users, you reduce the costs of hosting
    and maintaining it.
    </p>),
    price: 30.95)
product.image.attach(io: File.open(Rails.root.join('db', 'images', 'cprpo.png')), filename: 'cprpo.jpg')
product.save!
